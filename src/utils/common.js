...
const UI_TEXT = {
    en: {
        ...
        cliUnavailable: ({ reason }) => `Embedded Console execution unavailable, switched to External App. Reason: ${reason}`,
        cliOfferGuiFallback: ({ reason }) => `Embedded Console execution hit an extension error: ${reason}`,
        useStataApp: 'Use External App',
        stayInCli: 'Stay in Embedded Console',
        sideLeft: 'left',
        sideRight: 'right',
        cliPreviewTooNarrow: ({ side }) => `The current VS Code window is too narrow. Please maximize or widen the window so that the Stata All in One Console can expand on the ${side}.`,
        cliPreviewStillNarrow: 'The current VS Code window is still too narrow. Stata All in One Console will continue running in the bottom panel.',
        cliLogoFallbackStarted: 'Stata All in One Console started...',
        runModeUnsupportedOnWindows: ({ mode }) => `${mode} is currently unavailable on Windows. Switched to External App.`,
        webviewPanelTitle: 'Stata All in One Console',
    ...
    zh: {
        ...
        cliUnavailable: ({ reason }) => `Embedded Console 执行不可用，已切换到 External App。原因：${reason}`,
        cliOfferGuiFallback: ({ reason }) => `Embedded Console 执行遇到扩展错误：${reason}`,
        useStataApp: '使用 External App',
        stayInCli: '留在 Embedded Console',
        sideLeft: '左侧',
        sideRight: '右侧',
        cliPreviewTooNarrow: ({ side }) => `检测到 VS Code 窗口宽度不足，建议最大化或适当拉宽窗口，以便 Stata All in One Console 在${side}展开。`,
        cliPreviewStillNarrow: '检测到 VS Code 窗口宽度仍不足，Stata All in One Console 将继续在下方面板中运行。',
        cliLogoFallbackStarted: 'Stata All in One Console 已启动...',
