...
const UI_TEXT = {
    en: {
        ...
        stataSetupQuickPickPlaceholder: 'Complete steps 1 and 2 in order. This window closes automatically after Stata connects.',
        ...
        stataSetupQuickPickInstallCopiedHint: 'Installation command copied. Paste it into external Stata and wait for “installation complete”, then continue with step 2.',
    ...
    zh: {
        ...
        stataSetupQuickPickPlaceholder: '请按顺序完成步骤 1 和步骤 2；Stata 连接成功后，本窗口会自动关闭。',
        ...
        stataSetupQuickPickInstallCopiedHint: '安装命令已复制。请粘贴到外部 Stata，等待“installation complete”，然后继续步骤 2。',
