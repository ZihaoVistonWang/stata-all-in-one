...
const UI_TEXT = {
    en: {
        ...
        stataDiscoveryManualExePath: 'Manually enter another Stata EXE path',
        stataDiscoveryManualMacApp: 'Manually select another Stata application',
        stataDiscoveryMacAppInvalid: 'Please select a StataMP.app, StataSE.app, StataBE.app, or StataIC.app application.',
    ...
    zh: {
        ...
        stataDiscoveryManualExePath: '手动填入其他Stata exe路径',
        stataDiscoveryManualMacApp: '手动选择其他 Stata 应用',
        stataDiscoveryMacAppInvalid: '请选择 StataMP.app、StataSE.app、StataBE.app 或 StataIC.app 应用。',
