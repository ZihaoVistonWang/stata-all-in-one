...
const UI_TEXT = {
    en: {
        ...
        sideLeft: 'left',
        sideRight: 'right',
        consolePreviewTooNarrow: ({ side }) => `The current VS Code window is too narrow. Please maximize or widen the window so that the Stata All in One Console can expand on the ${side}.`,
        consolePreviewStillNarrow: 'The current VS Code window is still too narrow. Stata All in One Console will continue running in the bottom panel.',
        consoleLogoFallbackStarted: 'Stata All in One Console started...',
        ...
        dataViewerPanelTitle: 'Stata Data Viewer',
    ...
    zh: {
        ...
        sideLeft: '左侧',
        sideRight: '右侧',
        consolePreviewTooNarrow: ({ side }) => `检测到 VS Code 窗口宽度不足，建议最大化或适当拉宽窗口，以便 Stata All in One Console 在${side}展开。`,
        consolePreviewStillNarrow: '检测到 VS Code 窗口宽度仍不足，Stata All in One Console 将继续在下方面板中运行。',
        consoleLogoFallbackStarted: 'Stata All in One Console 已启动...',
        runModeUnsupportedOnWindows: ({ mode }) => `${mode} 当前在 Windows 上不可用，已切换到 External App。`,
        webviewPanelTitle: 'Stata All in One控制台',
