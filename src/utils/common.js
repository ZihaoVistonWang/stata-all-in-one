...
const UI_TEXT = {
    en: {
        ...
        dataViewerCaptureTooLarge: ({ rows, megabytes }) => `Reading ${rows} observations at once would exceed the ${megabytes} MB data budget. Scroll to a smaller range or filter the data first.`, 
    ...
    zh: {
        ...
        dataViewerCaptureTooLarge: ({ rows, megabytes }) => `一次读取 ${rows} 个观测值将超出 ${megabytes} MB 的数据上限。请滚动到更小的范围或先筛选数据。`, 
