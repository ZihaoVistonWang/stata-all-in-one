...
const UI_TEXT = {
    en: {
        ...
        stataSetupCopyInstallCommand: 'Copy Installation Command',
        stataSetupCopySetupCommand: 'Copy saio setup',
        stataSetupCommandDone: 'Done',
        stataSetupCommandInstructions: ({ installCommand, setupCommand }) => `Configure Stata All in One from a separately opened Stata application outside VS Code:\n\n1. Install the saio command:\n${installCommand}\n\n2. Run setup:\n${setupCommand}\n\nDo not run these commands in the VS Code Embedded Console. The extension will keep listening while VS Code is open.`,
    ...
    zh: {
        ...
        stataSetupCopyInstallCommand: '复制安装命令',
        stataSetupCopySetupCommand: '复制 saio setup',
        stataSetupCommandDone: '完成',
        stataSetupCommandInstructions: ({ installCommand, setupCommand }) => `请在 VS Code 外部单独打开的 Stata 软件中完成配置：\n\n1. 安装 saio 命令：\n${installCommand}\n\n2. 运行配置：\n${setupCommand}\n\n请勿在 VS Code 内置 Console 中运行。只要 VS Code 保持打开，扩展就会持续等待该配置命令。`,
