...
const CHANGELOG = {
    en: {
        '0.2.16': {
            ...
            more_url: 'https://github.com/ZihaoVistonWang/stata-all-in-one/blob/main/CHANGELOG.md#0216-0214-2026-05-31'
        },
        '0.2.15': {
    ...
    zh: {
        '0.2.16': {
            ...
            more_url: 'https://gitee.com/ZihaoVistonWang/stata-all-in-one/blob/main/CHANGELOG.md#0216-0214-2026-05-31'
        },
        '0.2.15': {
