# Keyboard Shortcuts for Stata All in One Extension
# Stata All in One的快捷键指南

This document provides a list of keyboard shortcuts available in the "Stata All in One" extension for Visual Studio Code. These shortcuts are designed to enhance your productivity while working with Stata code.

这份文档列出了Visual Studio Code中“Stata All in One”扩展提供的键盘快捷键。这些快捷键旨在提高您处理Stata代码时的工作效率。
...
| `Ctrl/Cmd + Shift + 8`                                | Insert Asterisk Separator / 插入星号分隔符                     |
